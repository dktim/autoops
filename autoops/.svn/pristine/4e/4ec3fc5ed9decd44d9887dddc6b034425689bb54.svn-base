...
function start_page_with_lsn_state(){
	reg=$('#regname').text()
	//alert(reg)
    jQuery.ajax({
        url: "/monitor/start_page_with_lsn_state",
        data: {'reg':reg},
        type:"get",
        dataType:"json",
...
//alert(ip);
    jQuery.ajax({
        url: "/monitor/get_lsn_ajax_state",
...
function query_fenshi_state(obj)
{   var value=$(obj).text();
	alert(value);
}
